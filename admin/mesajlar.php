...
if($_GET['islem']=="sil")
{
	...
	$fotograf_sil_sorgu = mysql_query("delete from iletisim where id='$id'");
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           <thead>
                              <tr>
                                 ...
                                 <th>Firma <i class="icon-angle-down" style="float:right;"></th>
                                 <th class="hidden-480">Tarih <i class="icon-angle-down" style="float:right;"></th>
