...
if($_POST['sira'] && $_GET['islem']=="")
{
	...
	$hedef  = "../wp-content/uploads/video/".$yeni_isim;
	...
	$kategori_ekle_sorgu=mysql_query("INSERT INTO video SET 
											durum		=	'$durum', 
											aciklama	=	'$aciklama', 
											sira		=	'$sira', 
											seo			=	'$seo',
...
if($_POST['sira'] && $_GET['islem']=="duzenle")
{
	...
	if($dosya!="")
	{
		$resim_bul=mysql_fetch_array(mysql_query("select * from video where id='$duzenlenecek_id'"));
		$resim_sil=unlink("../wp-content/uploads/video/".$resim_bul['resim']);
	
		$fotograf_duzenle_sorgu=mysql_query("UPDATE video SET 
											durum		=	'$durum', 
											aciklama	=	'$aciklama', 
											sira		=	'$sira', 
											seo			=	'$seo',
	...
	{	
	$referans_duzenle_sorgu=mysql_query("UPDATE video SET 
											durum		=	'$durum', 
											aciklama	=	'$aciklama', 
											sira		=	'$sira', 
											seo			=	'$seo',
...
if($_GET['islem']=="duzenle")
{
	...
	$referans_dizi=mysql_fetch_array(mysql_query("select * from video where id='$foto_id'"));
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-tags"></i> Video Ekleme / Güncelleme</h4>
                    ...
                    <?=$bilgi?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                           ...
                           <div class="control-group">
                              <label class="control-label">Video Adı</label>
                              <div class="controls">
