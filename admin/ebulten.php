...
if($_GET['islem']=="sil")
{
	...
	$sayfa_sil_sorgu = mysql_query("delete from ebulten where id='$id'");
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-edit"></i> E-Bülten Listesi</h4>
                     ...
                     <div class="widget-body">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           <thead>
                              <tr>
                                 <th style="width:8px;">Mail</th>
                                 <th> Kayıt Tarihi <i class="icon-angle-down" style="float:right;"></th>
                           ...
                           <?php
						    $sayfa_cek=mysql_query("select * from ebulten order by id desc");
