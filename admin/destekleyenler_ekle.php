...
if($_POST['sira'] && $_GET['islem']=="")
{
	...
	$upload->process("../wp-content/uploads/destek");
	...
	$upload->image_x = 170;
	$upload->image_y = 60;
	$upload->process("../wp-content/uploads/destek/kucuk");
	if ($upload->processed){
	$destekresim=''.$upload->file_dst_name.'';
	}
	}
	if($destekresim=="")
	$destekresim="no-image";
	$gitti=$destekresim=''.$upload->file_dst_name.'';
	
	$kategori_ekle_sorgu=mysql_query("INSERT INTO destekleyenler SET 
											durum		=	'$durum', 
											aciklama	=	'$aciklama', 
											sira		=	'$sira', 
											adi			=	'$adi', 
...
if($_POST['sira'] && $_GET['islem']=="duzenle")
{
	...
	if($destekresim!="")
	{
		$resim_bul=mysql_fetch_array(mysql_query("select * from destekleyenler where id='$duzenlenecek_id'"));
		$resim_sil=unlink("../wp-content/uploads/destek/".$resim_bul['resim']);
		$resim_sil2=unlink("../wp-content/uploads/destek/kucuk/".$resim_bul['resim']);
	
		$fotograf_duzenle_sorgu=mysql_query("UPDATE destekleyenler SET 
											durum		=	'$durum', 
											aciklama	=	'$aciklama', 
											sira		=	'$sira', 
											adi			=	'$adi', 
	...
	{	
	$referans_duzenle_sorgu=mysql_query("UPDATE destekleyenler SET 
											durum		=	'$durum', 
											aciklama	=	'$aciklama', 
											sira		=	'$sira', 
											adi			=	'$adi'
...
if($_GET['islem']=="duzenle")
{
	...
	$referans_dizi=mysql_fetch_array(mysql_query("select * from destekleyenler where id='$foto_id'"));
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-tags"></i> Destekleyenler Ekleme / Güncelleme</h4>
                    ...
                    <?=$bilgi?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                           ...
                           <div class="control-group">
                              <label class="control-label">Destekleyenler Adı</label>
                              <div class="controls">
                           ...
                           <div class="control-group">
                              <label class="control-label">Destekleyenler Link</label>
                              <div class="controls">
                                 <input name="aciklama" type="text" class="span6 " value="<?=$referans_dizi['aciklama']?>"/>
                              </div>
                           </div>
