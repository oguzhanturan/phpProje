...
if($_GET['islem']=="sil")
{
	...
	$resim_bul=mysql_fetch_array(mysql_query("select * from uyeler where id='$id'"));
	$resim_sil=unlink("../wp-content/uploads/uyeler/".$resim_bul['resim']);
	
	$uyeler_sil_sorgu = mysql_query("delete from uyeler where id='$id'");
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-tags"></i> Üye Listesi</h4>
                     ...
                     <div class="widget-body">
                        <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              ...
                              <a href="uye_ekle.php" style="color:#FFF;">Üye Ekle</a> <i class="icon-plus"></i>
                              </div>
                           </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           <thead>
                              <tr>
                                 ...
                                 <th> Üye Adı <i class="icon-angle-down" style="float:right;"></th>
                           ...
                           <?php
						    $referans_cek=mysql_query("select * from uyeler order by sira asc");
						   ...
						   ?>
                              ...
                              <tr class="odd gradeX">
								 ...
								 {
								 ?>
                                 <a href="../wp-content/uploads/uyeler/<?=$referans_dizi['resim']?>" target="_blank">Resmi Gör</a>
                                 <?php
								 }
								 ?></td>
                                 ...
                                 <a href="uye_ekle.php?islem=duzenle&id=<?=$referans_dizi['id']?>" title="Düzenle">
