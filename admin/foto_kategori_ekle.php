...
if($_POST['kategori_sira'] && $_GET['islem']=="")
{
	...
	$upload->process("../wp-content/uploads/galeri");
	if ($upload->processed){
	...
	$kategori_ekle_sorgu=mysql_query("INSERT INTO fotograf_galeri_kategori SET 
											durum			=	'$durum', 
											sira			=	'$kategori_sira', 
											seo				=	'$seo',
											kategori_adi	=	'$kategori_adi', 
											kategori_resim	=	'$kategoriresim'");
...
if($_POST['kategori_sira'] && $_GET['islem']=="duzenle")
{
	...
	if($kategoriresim!="")
	{
		...
		$yonetici_duzenle_sorgu=mysql_query("UPDATE fotograf_galeri_kategori SET 
											durum			=	'$durum', 
											sira			=	'$kategori_sira', 
											seo				=	'$seo',
											kategori_adi	=	'$kategori_adi', 
