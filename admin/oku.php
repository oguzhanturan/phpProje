                    ...
                    <div class="widget-body form">
                        ...
                        <!-- BEGIN FORM-->
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                              <input type="text" disabled autocomplete="off" value="<?=$sayfa_dizi['ad']?>">
                      ...
                      <div class="control-group">
                              ...
                              <div class="controls">
                              <input type="text" disabled value="<?=$sayfa_dizi['firma']?>">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                              <input type="text" disabled value="<?=$sayfa_dizi['telefon']?>">
                          ...
                          <div class="control-group">
                              ...
                              <div class="controls">
                              <input type="text" disabled value="<?=$sayfa_dizi['mail']?>">
                      ...
                      <div class="control-group">
                                 ...
                                 <div class="controls">
                                 <textarea disabled="disabled"><?=$sayfa_dizi['mesaj']?></textarea>
