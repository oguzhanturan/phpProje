...
if($_GET['islem']=="sil")
{
	...
	$sayfa_sil_sorgu = mysql_query("delete from siparis where id='$id'");
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-edit"></i> sipariş Listesi</h4>
                     ...
                     <div class="widget-body">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           <thead>
                              <tr>
                                 <th>Adı Soyad <i class="icon-angle-down" style="float:right;"></th>
                                 <th class="hidden-480">Ürün Kodu <i class="icon-angle-down" style="float:right;"></th>
                                 <th class="hidden-480">Mail <i class="icon-angle-down" style="float:right;"></th>
                                 <th class="hidden-480">Telefon <i class="icon-angle-down" style="float:right;"></th>
                                 <th class="hidden-480">Konu <i class="icon-angle-down" style="float:right;"></th>
                                 <th class="hidden-480">Mesaj <i class="icon-angle-down" style="float:right;"></th>
                           ...
                           <?php
						    $sayfa_cek=mysql_query("select * from siparis order by id desc");
							while($sayfa_dizi=mysql_fetch_array($sayfa_cek))
							{
						   ?>
                           
                              <tr class="odd gradeX">
                                 <td><?=$sayfa_dizi['adsoyad']?></td>
                                 <td><?=$sayfa_dizi['kodu']?></td>
                                 <td><?=$sayfa_dizi['mail']?></td>
                                 <td><?=$sayfa_dizi['telefon']?></td>
                                 <td><?=$sayfa_dizi['konu']?></td>
                                 <td><?=$sayfa_dizi['mesaj']?></td>
