...
if($_POST['fotograf_sira'] && $_GET['islem']=="")
{
	...
	$hedef  = "../wp-content/uploads/galeri/".$yeni_isim;
	...
	$kategori_ekle_sorgu=mysql_query("INSERT INTO fotograf_galeri SET 
											durum		=	'$durum', 
											sira		=	'$fotograf_sira', 
											adi			=	'$fotograf_adi', 
											resim		=	'$yeni_isim', 
...
if($_POST['fotograf_sira'] && $_GET['islem']=="duzenle")
{
	...
	if($dosya!="")
	{
		...
		$resim_sil=unlink("../wp-content/uploads/galeri/".$resim_bul['resim']);
	
		$fotograf_duzenle_sorgu=mysql_query("UPDATE fotograf_galeri SET 
											durum		=	'$durum', 
											sira		=	'$fotograf_sira', 
											adi			=	'$fotograf_adi', 
											resim		=	'$yeni_isim', 
