...
$urun_id = $_GET['urun_id'] ;
				...
				if($_POST['EKLE']=="EKLE")
				{
				  ...
				  $hedef  = "../wp-content/uploads/faaliyet/diger/".$yeni_isim; 
				  $gitti=move_uploaded_file($kaynak,$hedef);
										
					$sayfa_ekle_sorgu=mysql_query("insert into faliyet_galeri (urun_id, resim) values ('$urun_id','$yeni_isim')");
				  ...
				  {
				  $gid=$_GET['gid'];
				  $sayfa_sil_sorgu = mysql_query("delete from faliyet_galeri where id='$gid'");
				  }
...
<tr>
<td colspan="2"><?php
$sayfa_cek=mysql_query("select * from faliyet_galeri where urun_id='$urun_id' order by id asc");
...
<img src="../wp-content/uploads/faaliyet/diger/<?=$sayfa_dizi['resim']?>" width="150" height="100" style="float:left;"/><br />
