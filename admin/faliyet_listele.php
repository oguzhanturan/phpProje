...
if($_GET['islem']=="sil")
{
	...
	$resim_bul=mysql_fetch_array(mysql_query("select * from faliyetler where id='$id'"));
	$resim_sil=unlink("../wp-content/uploads/faaliyet/".$resim_bul['resim']);
	
	$duyuru_sil_sorgu = mysql_query("delete from faliyetler where id='$id'");
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-bullhorn"></i> Faaliyet Listesi</h4>
                     ...
                     <div class="widget-body">
                        <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              ...
                              <a href="faliyet_ekle.php" style="color:#FFF;">Faaliyet Ekle</a> <i class="icon-plus"></i>
                              </div>
                           </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           <thead>
                              <tr>
                                 ...
                                 <th> Faaliyet Adı <i class="icon-angle-down" style="float:right;"></th>
                                 <th class="hidden-480">Faaliyet Resmi <i class="icon-angle-down" style="float:right;"></th>
                           ...
                           <?php
						    $duyuru_cek=mysql_query("select * from faliyetler order by sira asc");
						   ...
						   ?>
                              ...
                              <tr class="odd gradeX">
								 ...
								 {
								 ?>
                                 <a href="../wp-content/uploads/faaliyet/<?=$duyuru_dizi['resim']?>" target="_blank">Resmi Gör</a>
                                 <?php
								 }
								 ?>
                                 ...
                                 <a href="faliyet_ekle.php?islem=duzenle&id=<?=$duyuru_dizi['id']?>" title="Düzenle">
