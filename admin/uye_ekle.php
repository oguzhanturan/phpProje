...
if($_POST['sira'] && $_GET['islem']=="")
{
	...
	$hedef  = "../wp-content/uploads/uyeler/".$yeni_isim;
	...
	$kategori_ekle_sorgu=mysql_query("INSERT INTO uyeler SET 
											durum		=	'$durum', 
											aciklama	=	'$aciklama', 
											sira		=	'$sira', 
											gorev		=	'$gorev', 
...
if($_POST['sira'] && $_GET['islem']=="duzenle")
{
	...
	if($dosya!="")
	{
		$resim_bul=mysql_fetch_array(mysql_query("select * from uyeler where id='$duzenlenecek_id'"));
		$resim_sil=unlink("../wp-content/uploads/uyeler/".$resim_bul['resim']);
	
		$fotograf_duzenle_sorgu=mysql_query("UPDATE uyeler SET 
											durum		=	'$durum', 
											aciklama	=	'$aciklama', 
											sira		=	'$sira', 
											gorev		=	'$gorev', 
	...
	{	
	$referans_duzenle_sorgu=mysql_query("UPDATE uyeler SET 
											durum		=	'$durum', 
											aciklama	=	'$aciklama', 
											sira		=	'$sira', 
											gorev		=	'$gorev', 
...
if($_GET['islem']=="duzenle")
{
	...
	$referans_dizi=mysql_fetch_array(mysql_query("select * from uyeler where id='$foto_id'"));
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-tags"></i> Üye Ekleme / Güncelleme</h4>
                    ...
                    <?=$bilgi?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="control-group">
                              <label class="control-label">Üye Sırası</label>
                              <div class="controls">
                           ...
                           <div class="control-group">
                              <label class="control-label">Üye Görevi</label>
                              <div class="controls">
                                 <input name="gorev" type="text" class="span6 " value="<?=$referans_dizi['gorev']?>"/>
                              </div>
                           </div>
