...
if($_GET['islem']=="sil")
{
	...
	$resim_bul=mysql_fetch_array(mysql_query("select * from manset where id='$id'"));
	$resim_sil=unlink("../wp-content/uploads/manset/".$resim_bul['resim']);
	
	$referanslar_sil_sorgu = mysql_query("delete from manset where id='$id'");
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-tags"></i> Manşet Listesi</h4>
                     ...
                     <div class="widget-body">
                        <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              ...
                              <a href="manset_ekle.php" style="color:#FFF;">Manşet Ekle</a> <i class="icon-plus"></i>
                              </div>
                           </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           <thead>
                              <tr>
                                 ...
                                 <th> manset Adı <i class="icon-angle-down" style="float:right;"></th>
                                 <th class="hidden-480" style="width:100px;">Resmi <i class="icon-angle-down" style="float:right;"></th>
                           ...
                           <?php
						    $referans_cek=mysql_query("select * from manset order by sira asc");
						   ...
						   ?>
                              ...
                              <tr class="odd gradeX">
								 ...
								 {
								 ?>
                                 <a href="../wp-content/uploads/manset/<?=$referans_dizi['resim']?>" target="_blank">Resmi Gör</a>
                                 <?php
								 }
								 ?></td>
                                 ...
                                 <a href="manset_ekle.php?islem=duzenle&id=<?=$referans_dizi['id']?>" title="Düzenle">
